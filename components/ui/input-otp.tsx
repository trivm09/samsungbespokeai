    ...
    ({ index, className, ...props }, ref) => {
        ...
        return (
            <div
                ref={ref}
                className={cn(
                    "relative flex h-[3.5rem] w-[3rem] items-center justify-center rounded-md border-y border-r border-neutral-200 bg-white text-sm transition-all",
            ...
            >
                ...
                {hasFakeCaret && (
                    <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                        <div className="animate-caret-blink h-4 w-px bg-neutral-950 duration-1000" />
                    </div>
                )}
            </div>
        );
